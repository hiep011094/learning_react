...
const DetailProduct = () => {
    ...
    const data_pages = [{ title: "Home", link: "/" }, { title: "Shop", link: "/shop" }, { title: params.productId, link: "/" }];
    ...
    const settings = {
        ...
        customPaging: function (i) {
            return (
                <span key={i}><img onClick={() => setItemZoom(i)} src={GROUP2[i]} alt={"item-" + i} /></span>
            );
        },
    };
            ...
            <div className='p-detailProduct__inner l-container'>
                <div className='p-detailProduct__content'>
                                ...
                                {1 && (
                                    GROUP2.map((img, index) => (
                                        <LightgalleryItem group="group2" key={index} src={img}>
                                            <span className='img'><img onMouseMove={(e) => handleZoom(e, img)} onMouseLeave={handleZoomOut} src={img} alt="img" /></span>
                                        </LightgalleryItem>
                                    ))
                                )}
                            </SliderSlick>
                    ...
                    <div className='content-product'>
                        ...
                        <div className='rate'>
                            <Rate /><span className='review'>(1 customer review)</span>
                        </div>
                        <p className='des'>The slick and designed Solar t-shirt by Zoli. features an intricate triangle print and tops stitched chest pocket in contrast colouring.</p>
                        <span className='price'>$28.00</span>
                        <div className='form-item'>
                            <SelectEl refOutSize={refOutSize} name="size" data={['S', 'M', 'L', 'XL', 'XXL']} />
                            <SelectEl refOutSize={refOutSize} name="color" data={['White', 'Green', 'Blue', 'Dress', 'XXL']} />
                        </div>
                        <div className='form-item'>
                        ...
                        <div className='content-product__item'>
                            <p><span>Categories:</span>Mens, Others, Uncategorized, Womens</p>
                            <ul>
                            ...
                            <div className='list-review'>
                                <div className='list-review__item'>
                                    ...
                                    <div className='infor'>
                                        ...
                                        <p className='content'>Congratulations!<br /> Amazing Work, Good Luck With Sale</p>
                                    </div>
                                </div>
                                <div className='list-review__item'>
                                    <span className='avatar'>
